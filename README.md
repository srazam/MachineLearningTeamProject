...
## How to Run Files
- Make sure to change the file paths in the script to '../public_cases.json' to access the data file if you're using Mac/Linux or '..\\public_cases.json' if you're using Windows.
- For '.py' files: change terminal's current directory into the same as the script's directory. Then run 'python scriptName.py' in the terminal. 
...
- polynomialRegression.py - implemented a linear regression variant, polynomial regression
...
### Final Deliverables
The 'finalDeliverables' folder contains our final technical report as well as the relevant graphs and visualizations used in the report.
